...
CREATE TABLE
  IF NOT EXISTS comentarios (
    ...
    PRIMARY KEY (id),
    KEY fk_post (id_post),
    CONSTRAINT fk_post FOREIGN KEY (id_post) REFERENCES posts (id) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin;

-- Insertar usuarios
INSERT INTO
  usuarios (usuario, contraseña, email, alias, fecha_registro)
VALUES
  (
    'juan123',
    'claveSegura1',
...
-- Insertar posts
INSERT INTO
  posts (id_usuario, titulo, cuerpo)
VALUES
  (
    1,
    'Mi primer post',
  ...
  (
    2,
    'Receta de cocina',
    'Hoy compartiré una receta fácil y rápida.'
  ),
  (
    3,
    'Consejos de programación',
    'Aquí van algunos consejos útiles para programadores.'
  );

-- Insertar comentarios
INSERT INTO
  comentarios (id_post, texto)
VALUES
