CREATE DATABASE IF NOT EXISTS centros_ocio;
USE centros_ocio;
...
-- Crear tabla registros (depende de socios y centros)
...
-- Crear tabla matriculas (depende de centros, socios y actividades)
...
-- Crear tabla salas (depende de centros)
...
-- Crear tabla reservas (depende de salas y socios)
...
INSERT INTO socios (dni, nombre, primer_apellido, segundo_apellido, numero_cuenta, telefono, email, fecha_nacimiento)
VALUES
    ('12345678A', 'Juan', 'Pérez', 'García', 123456, '600123456', 'juan.perez@email.com', '1985-06-15'),
    ('87654321B', 'María', 'López', 'Martínez', 654321, '611987654', 'maria.lopez@email.com', '1992-09-22'),
    ('11223344C', 'Carlos', 'Fernández', 'Ruiz', 112233, '622456789', 'carlos.fernandez@email.com', '1978-11-30');

-- Insertar datos en centros
INSERT INTO centros (cod_centro, nombre, direccion, ciudad, telefono, email)
VALUES
    ('C01', 'Centro Deportivo Norte', 'Av. Libertad 123', 'Madrid', '915678910', 'centronorte@email.com'),
    ('C02', 'Centro Fitness Sur', 'Calle Sol 45', 'Sevilla', '955123456', 'centrosur@email.com');

-- Insertar datos en actividades
INSERT INTO actividades (nombre, fecha, explicacion)
VALUES
    ('Yoga', '2025-03-15 10:00:00', 'Clase de relajación y meditación a través del yoga.'),
    ('Zumba', '2025-03-16 18:00:00', 'Clase de baile fitness al ritmo de la música.'),
    ('CrossFit', '2025-03-17 19:30:00', 'Entrenamiento de alta intensidad para mejorar fuerza y resistencia.');

-- Insertar datos en registros
INSERT INTO registros (dni, cod_centro, fecha_alta)
VALUES
...
INSERT INTO matriculas (cod_centro, dni, cod_actividad)
VALUES
    ('C01', '12345678A', 1),
    ('C02', '87654321B', 2),
    ('C01', '11223344C', 3);
...
INSERT INTO salas (nombre_sala, cod_centro)
VALUES
    ('Sala A', 'C01'),
    ('Sala B', 'C02'),
    ('Sala C', 'C01');
...
INSERT INTO reservas (nombre_sala, dni, fecha, hora_inicio, hora_fin)
VALUES
    ('Sala A', '12345678A', '2025-03-20 09:00:00', '09:00:00', '10:00:00'),
    ('Sala B', '87654321B', '2025-03-21 18:00:00', '18:00:00', '19:30:00'),
    ('Sala C', '11223344C', '2025-03-22 19:30:00', '19:30:00', '21:00:00');