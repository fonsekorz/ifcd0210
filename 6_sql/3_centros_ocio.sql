...
INSERT INTO socios (dni, nombre, primer_apellido, segundo_apellido, numero_cuenta, telefono, email, fecha_nacimiento) VALUES
...
INSERT INTO centros (cod_centro, nombre, direccion, ciudad, telefono, email) VALUES
...
INSERT INTO actividades (nombre, fecha, explicacion) VALUES
...
INSERT INTO registros (dni, cod_centro, fecha_alta) VALUES
...
INSERT INTO matriculas (cod_centro, dni, cod_actividad) VALUES
('C01', '12345678A', 1),
('C02', '87654321B', 2),
('C01', '11223344C', 3);

-- Insertar datos en salas
INSERT INTO salas (nombre_sala, cod_centro) VALUES
('Sala A', 'C01'),
('Sala B', 'C02'),
('Sala C', 'C01');

-- Insertar datos en reservas
INSERT INTO reservas (nombre_sala, dni, fecha, hora_inicio, hora_fin) VALUES
